...
I’m a Frontend Developer passionate about building interactive, user-friendly, and visually stunning web experiences.  

- My focus: **React, Vite, and UI/UX Design**, but I’m always exploring new frontend frameworks.  
- Currently working with **React, TailwindCSS, and JavaScript** to craft responsive and modern UIs.  

## Technologies I Use
- Proficient In: HTML, CSS, JavaScript, Vite React, TailwindCSS  
- Still Learning: TypeScript, Next.js, Framer Motion, UI Animation  
